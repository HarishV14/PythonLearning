...
class ToRomanBadInput(unittest.TestCase):
    def test_too_large(self):
        ...
        third field '''
        self.assertRaises(roman.OutOfRangeError, roman.to_roman, 783)  # Test with a value greater than 783
    ...
    def test_nonInteger(self):
        ...
        self.assertRaises(roman.NotIntegerError,roman.to_roman,2.34)
